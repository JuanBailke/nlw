...
export default function Market() {
    ...
    async function handleOpenCamera() {
        try {
            ...
            if (!granted) {
                return Alert.alert("Câmera", "Você precisa permitir acesso a câmera para ler o QR Code.")
            }
    ...
    async function getCoupon(id: string) {
        try {
            ...
            console.log(error)
            Alert.alert("Erro", "Não foi possivel carregar o cupom.")
        } finally {
    ...
    return (
        <View style={{ flex: 1 }}>
            ...
            <Modal style={{ flex: 1 }} visible={isVisibleCameraModal}>
                <CameraView
                    style={{ flex: 1 }}
                    facing="back" onBarcodeScanned={({ data }) => {
